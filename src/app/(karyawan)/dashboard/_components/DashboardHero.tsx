...
const MOTIVATIONAL_QUOTES = [
  ...
  "Satu jam belajar hari ini adalah batu loncatan menuju karier gemilang Anda di masa depan.",
  "Konsistensi adalah pembeda antara pemimpi dan mereka yang benar-benar mencapai tujuan.",
  "Tantangan dalam latihan adalah persiapan terbaik untuk kesuksesan di lapangan.",
  "Waktu yang dihabiskan untuk menajamkan pedang tidak pernah sia-sia. Ayo mulai belajarmu!",
];
...
export const DashboardHero = ({ userName, resumeData, performanceStatus }: DashboardHeroProps) => {
  ...
  useEffect(() => {
    ...
    // 2. Daily Dynamic Quote
    // Menghasilkan indeks berdasarkan hari dalam tahun (berubah setiap hari, persisten dalam sehari)
    ...
    <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-[3rem] p-8 md:p-14 flex flex-col md:flex-row md:items-center justify-between gap-10 shadow-2xl relative overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col gap-y-5 max-w-2xl text-white">
        ...
        <div className="space-y-2 select-none">
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-none drop-shadow-md transition-all duration-500">
            {isMounted ? greeting : "Selamat Datang"}, <br />
        ...
        <p className="text-slate-300 font-medium text-lg leading-relaxed mt-2 max-w-md border-l-4 border-[#E8A020] pl-6 transition-all duration-500">
          {isMounted ? quote : MOTIVATIONAL_QUOTES[0]}
        </p>
