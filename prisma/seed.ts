...
async function main() {
  ...
  // Create More Karyawan 4-10
  const karyawanDewi = await prisma.user.upsert({
    where: { email: "dewi.kusuma@bnif.co.id" },
    update: {},
    create: {
      email: "dewi.kusuma@bnif.co.id",
      name: "Dewi Kusuma",
      password: userPassword,
      role: "KARYAWAN",
      department: "Human Resources",
  ...
  const karyawanEko = await prisma.user.upsert({
    where: { email: "eko.susanto@bnif.co.id" },
    update: {},
    create: {
      email: "eko.susanto@bnif.co.id",
      name: "Eko Susanto",
      password: userPassword,
      role: "KARYAWAN",
      department: "Credit Operations",
  ...
  const karyawanFani = await prisma.user.upsert({
    where: { email: "fani.wijaya@bnif.co.id" },
    update: {},
    create: {
      email: "fani.wijaya@bnif.co.id",
      name: "Fani Wijaya",
      password: userPassword,
      role: "KARYAWAN",
      department: "Finance & Accounting",
  ...
  const karyawanGita = await prisma.user.upsert({
    where: { email: "gita.nirmala@bnif.co.id" },
    update: {},
    create: {
      email: "gita.nirmala@bnif.co.id",
      name: "Gita Nirmala",
      password: userPassword,
      role: "KARYAWAN",
      department: "IT Infrastructure",
  ...
  const karyawanHadi = await prisma.user.upsert({
    where: { email: "hadi.prakoso@bnif.co.id" },
    update: {},
    create: {
      email: "hadi.prakoso@bnif.co.id",
      name: "Hadi Prakoso",
      password: userPassword,
      role: "KARYAWAN",
      department: "Marketing",
  ...
  const karyawanIndah = await prisma.user.upsert({
    where: { email: "indah.permata@bnif.co.id" },
    update: {},
    create: {
      email: "indah.permata@bnif.co.id",
      name: "Indah Permata",
      password: userPassword,
      role: "KARYAWAN",
      department: "Human Resources",
  ...
  const karyawanJoko = await prisma.user.upsert({
    where: { email: "joko.widodo@bnif.co.id" },
    update: {},
    create: {
      email: "joko.widodo@bnif.co.id",
      name: "Joko Widodo",
      password: userPassword,
      role: "KARYAWAN",
      department: "Credit Operations",
  ...
  console.log({ 
    admin, 
    karyawan: [user, karyawanBudi, karyawanSiti, karyawanAndi, karyawanDewi, karyawanEko, karyawanFani, karyawanGita, karyawanHadi, karyawanIndah, karyawanJoko], 
